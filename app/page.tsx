  ...
  return (
    <ScreenFrame>
      <section className="panel space-y-5 text-center px-4 py-8">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-muted">THE REAL LOYALTY TEST</p>
        <h1 className="headline text-[28px] leading-tight">
          Some people stay solid.<br />
          Some people switch.<br />
          Which one are you?
        </h1>
        <p className="text-[15px] leading-relaxed text-brand-muted pt-2 pb-4">
          Takes about 60 seconds. Find out who you are when loyalty gets tested. Your result unlocks at the end.
        </p>
